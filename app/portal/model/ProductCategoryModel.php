...
//        }
        ...
        foreach ($categories as $item) {
            ...
            $item['str_action'] = '<a href="' . url("ProductCategory/add", ["parent" => $item['id']]) . '">添加子分类</a>  <a href="' . url("ProductCategory/edit", ["id" => $item['id']]) . '">' . lang('EDIT') . '</a>  <a class="js-ajax-delete" href="' . url("ProductCategory/delete", ["id" => $item['id']]) . '">' . lang('DELETE') . '</a> ';
            array_push($newCategories, $item);
        }
